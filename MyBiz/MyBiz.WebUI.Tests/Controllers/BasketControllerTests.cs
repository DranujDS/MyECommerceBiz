...
namespace MyBiz.WebUI.Tests.Controllers
{
  ...
  public class BasketControllerTests
  {
    ...
    public void CanCheckoutAndCreateOrder()
    {
      ...
      customers.Insert( new Customer() { Id = "1", Email = "junardds@gmail.com", Zipcode = "2316" } );
      IPrincipal FakeUser = new GenericPrincipal( new GenericIdentity( "junardds@gmail.com", "Forms" ), null );
      ...
      //Customer customer = customers.Collection().FirstOrDefault(c => c.Email == User )
